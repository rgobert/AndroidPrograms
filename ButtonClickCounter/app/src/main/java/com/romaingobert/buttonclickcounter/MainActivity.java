    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View.OnClickListener ourOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                numTimesClicked++; //numTimesClicked = numTimesClicked + 1
                ...
                redImg.setBackgroundColor(Color.BLUE);
                blueImg.setBackgroundColor(Color.RED);
            }
        };
...
//            toastmessage.setGravity(2, 10, 10);
            toastmessage.show();
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.romaingobert.buttonclickcounter/http/host/path")
        );
